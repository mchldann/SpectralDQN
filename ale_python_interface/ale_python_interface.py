...
ale_lib.isUpdatingScreenImage.argtypes = [c_void_p]
ale_lib.isUpdatingScreenImage.restype = c_bool
...
class ALEInterface(object):
    ...
    def isUpdatingScreenImage(self):
        return ale_lib.isUpdatingScreenImage(self.obj)
