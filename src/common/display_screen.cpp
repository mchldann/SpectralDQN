        ...
        delay_msec(17)
{
    ...
    fprintf(stderr, "Screen Display Active. [Toggle Display Updating] 'd' [Manual Control Mode] 'm' "
...
bool DisplayScreen::isUpdatingScreenImage() {
    return update_screen_image;
}
    ...
    switch (event.type) {
        ...
        case SDL_KEYDOWN:
            switch(event.key.keysym.sym) {
                case SDLK_d:
                    update_screen_image = !update_screen_image;
                    break;
                case SDLK_m:
